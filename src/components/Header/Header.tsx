...
export const Header = ({ filter, setFilter, isAuth }: HeaderProps) => {
    ...
    useEffect(() => {
        ...
        const mobNav = document.querySelector('.navigation__mobile');

        if (menuButton && header && logo && mobNav) {
            menuButton.addEventListener('click', () => {
                menuButton.classList.toggle('menu-button__active');
                header.classList.toggle('site-header__menuOn');
                logo.classList.toggle('site-logo__active');
            ...
            window.addEventListener('resize', () => {
                if (document.body.clientWidth > 770) {
                    ...
                    header.classList.remove('site-header__menuOn');
                    logo.classList.remove('site-logo__active');
        ...
        <div className='site-header-wrp'>
            <div className='site-header'>
                <div className="site-header__content">
                    ...
                    {
                        isAuth ?
                            <div className='site-header_box'>
                                <nav className="site-header__nav">
                                    <div className="navigation">
                                        <Link to='/jogs' onClick={() => setUrl('/jogs')}><label>
                                        ...
                                        <label>
                                            <Link to='/info' onClick={() => setUrl('/info')}>
                                                <input type="radio" name="nav" />
                                                <h3 className="navigation-item">INFO</h3>
                                            </Link>
                                        </label>
                                        <label>
                                            <Link to='/contacts' onClick={() => setUrl('/contacts')}>
                                                <input type="radio" name="nav" />
                                                <h3 className="navigation-item navigation-item__last">CONTACT US</h3>
                                            </Link>
                                        </label>
                                    </div>
                                    <div className="menu-btn-wrp"><button id="menu-btn" className="menu-button"></button>
                ...
                <nav className="navigation__mobile">
                    <label>
                        <Link to='/jogs' onClick={() => setUrl('/jogs')}>
